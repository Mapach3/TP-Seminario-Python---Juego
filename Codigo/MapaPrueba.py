...
class Fondo(pygame.sprite.Sprite):
    def __init__(self):
        self.imagen=pygame.image.load("MapaTest\TestFondo.png").convert_alpha()
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        #creo 4 imagenes
        self.imagen1=pygame.image.load("MapaTest\animacion1.png").convert_alpha()
        self.imagen2=pygame.image.load("MapaTest\animacion2.png").convert_alpha()
        self.imagen3=pygame.image.load("MapaTest\animacion1l.png").convert_alpha()
        self.imagen4=pygame.image.load("MapaTest\animacion2l.png").convert_alpha() 
        ...
        self.rect=self.imagen.get_rect()
        self.rect.top,self.rect.left=(400,400)
